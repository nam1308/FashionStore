...
<template id="template">
    <input type="hidden" id="id-parent" value="{{$data->id}}" ref="id-parent">
    <div class="row">
        <div class="col-md-4">
            <div class="ibox">
                <div class="ibox-head">
                    <button class="btn" @click="handleBack">Back</button>
                    <div class="ibox-title">Attribute</div>
                </div>
                <div class="ibox-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <input class="form-control" type="text" disabled value="{{$data->slug}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label>Description</label>
                                <textarea disabled class="form-control" rows="4" style="resize:none">{{$data->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
        ...
        <div class="col-md-8">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Variations</div>
    ...
    <script>
        const app = Vue.createApp({
            ...
            methods: {
                ...
                showCreate(e){
                    this.id = 0,
                    this.titleModel = 'Create Variation'
                },
                async getData(query){
                    const start = (this.page - 1) * this.length
                    const res = await API.PRODUCT_ATTRIBUTE.SEARCH(query,start,this.length,this.parent)
                ...
                async showEdit(e){
                    try {
                        ...
                        this.id = id
                        this.titleModel = 'Edit Variation'
            ...
            mounted(){
                this.parent = this.$refs['id-parent'].value
                const that = this
            ...
            watch: {
                async page(newValue,oldValue){
                    try {
                        ...
                        const response = await API.PRODUCT_ATTRIBUTE.SEARCH(this.search,start,length,this.parent);
