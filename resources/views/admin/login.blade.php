            ...
            <div class="login-content">
                <form action="">
                    ...
                    <div class="input-div one focus">
                        ...
                        <div class="div">
                            <h5>Username</h5>
                            <input type="text" class="form-control input" v-model="user.username"/>
                        </div>
                    </div>
                    <div class="input-div pass focus">
                        ...
                        <div class="div">
                            <h5>Password</h5>
                            <input type="password" class="form-control input one focus" v-model="user.password"/>
                        </div>
                    </div>
                    <a href="#">Forgot Password?</a>
                    <button type="button" class="btn" @click="onSubmit">Login</button>
            ...
            methods: {
                ...
                async onSubmit() {
                    ...
                    try {
                        ...
                        let err = "";
                        if(this.user.username.trim() == '') { err = "username is empty"; }
                        else if(this.user.password.trim() == '') { err = "password is empty"; }
                        else { err = error; }
                        alert(err);
                        this.hideLoader();
                    }
